...
**MCP उपकरण पहुंच क्षमता के प्रमाणों को कैप्चर करने और निदान करने के लिए।**
...
HTML फ़ाइलों, CLI लॉग या अन्य इनपुट से छेड़छाड़-रोधी प्रमाण बंडल कैप्चर करें।
...
प्रमाण बंडलों पर नियतात्मक पहुंच क्षमता जांच चलाएं।
...
| `engine.capture.html_canonicalize_v0_1` | मानकीकरण के साथ HTML कैप्चर |
...
- **पहुंच प्राप्त डेटा:** प्रमाण कैप्चर के लिए डिस्क से HTML फ़ाइलों को पढ़ता है। पहुंच क्षमता निदान के लिए DOM स्नैपशॉट संसाधित करता है।
- **पहुंच प्राप्त डेटा नहीं:** कोई नेटवर्क अनुरोध नहीं। कोई टेलीमेट्री नहीं। कोई उपयोगकर्ता डेटा संग्रहण नहीं। कोई क्रेडेंशियल या टोकन नहीं।
- **आवश्यक अनुमतियाँ:** लक्ष्य HTML फ़ाइलों तक पढ़ने की पहुंच। प्रमाण बंडल आउटपुट के लिए लिखने की पहुंच।

## स्कोरकार्ड

| गेट | स्थिति |
|------|--------|
| A. सुरक्षा आधार रेखा | पास |
